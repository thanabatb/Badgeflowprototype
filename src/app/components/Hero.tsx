  ...
  return (
    <section className="relative overflow-hidden bg-white px-6 py-20 lg:px-8 min-h-[600px] flex items-center">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] opacity-30 pointer-events-none">
        <div className="absolute top-0 right-0 w-full h-full bg-amber-100 rounded-[40%_60%_70%_30%/60%_30%_70%_40%]"></div>
      </div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] opacity-20 pointer-events-none">
        <div className="absolute bottom-0 left-0 w-full h-full bg-amber-50 rounded-[60%_40%_30%_70%/40%_70%_30%_60%]"></div>
      </div>

      {/* Floating geometric elements */}
      <div className="absolute top-1/4 right-1/4 w-4 h-4 bg-white rounded-full opacity-60"></div>
      <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-amber-200 rounded-full opacity-40"></div>
      <div className="absolute bottom-1/3 right-1/5 w-24 h-24 bg-white rounded-full opacity-80 blur-sm"></div>
      <div className="absolute bottom-1/4 right-1/4 w-32 h-32 bg-amber-50 rounded-full opacity-50"></div>
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <Link to="/register">
              <Button
                size="lg"
                className="bg-amber-400 hover:bg-amber-500 text-amber-950 rounded-full px-8"
              >
                Get started
              </Button>
            </Link>
